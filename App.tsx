          ...
          <div className="mt-4 md:mt-0 flex items-center space-x-6">
            ...
            <div className="text-right hidden sm:block">
              ...
              <div className="flex items-center justify-end space-x-2 mt-1">
                <span className={`w-2 h-2 rounded-full ${isWarpSpeed ? 'bg-indigo-400 animate-ping' : 'bg-emerald-400 animate-pulse'}`}></span>
                <span className="text-sm font-medium text-slate-300">{isWarpSpeed ? 'Warp Active' : 'Operational'}</span>
              </div>
            </div>
          </div>
        </header>
        ...
        <main className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="lg:col-span-7 xl:col-span-8">
             <div className="h-full flex flex-col gap-6">
                ...
                <div className="flex-1"><QuoteGenerator /></div>
             </div>
          </div>
